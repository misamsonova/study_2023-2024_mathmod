...
$$ {dx\over {dt}} = -0.45x(t)-0.55y(t)+sin(t+15) $$
$$ {dy\over {dt}} = -0.58x(t)-045.y(t)+cos(t+3) $$

2. Модель ведение боевых действий с участием регулярных войск и партизанских отрядов:

$$ {dx\over {dt}} = -0.38x(t)-0.67y(t)+sin(7t)+1 $$
$$ {dy\over {dt}} = -0.57(t)y(t)-0.39y(t)+cos(8t)+1 $$

# Задачи

1. Построение модели боевых действий между регулярными войсками на языках Julia и OpenModelica.
2. Построение модели ведения боевых действий с участием регулярных войск партизанских отрядов на языках Julia и OpenModelica.
...
## Решение задач с помщью программ

### Julia

#### Программный код решения на Julia [1]

Напишем код программы для решения поставленной задачи:
...
```
Скомпелируем файл следующей командой в PowerShell:

!["Компляция программы lab03.jl"](image/1.jpg){#fig:001}

### Результаты работы кода на Julia

На рис. @fig:002 и @fig:003 изображены итоговые графики для обоих случаев.

!["Полученный график Julia. Первый случай"](image/2.jpg){#fig:002}

!["Полученный график Julia. Второй случай"](image/3.jpg){#fig:003}
...
На графиках на рис. @fig:004 и @fig:005, построенных с помощью OpenModelica изображены графики, аналогичные графикам @fig:002 и @fig:003 соответственно.

!["Полученный график OpenModelica. Первый случай"](image/4.jpg){#fig:004}

!["Полученный график OpenModelica. Второй случай"](image/5.jpg){#fig:005}
